...
public class HomeController {
    ...
    public String home(Model model) {
        ...
        model.addAttribute("pageDescription", "AI Forensic helps users analyze uploaded images for deepfake, edited, GAN-generated, or real-media patterns using AI-assisted forensic screening.");
